...
public class taskExcel05 {
        ...
        public void testDataDriven(String Email,String password, String ExpectedResult){
            ...
            if(ExpectedResult.equalsIgnoreCase("valid")){
                ...
                Assert.assertEquals(text,"practice selenium");
            }
    ...
    public Object[][] testDataExcel() throws IOException {
            String testDataFile="CTD.xlsx";
            XLUtility xlUtility=new XLUtility(testDataFile);
            Object[][] data=xlUtility.getDataFromSheet(testDataFile,"Data");
            return data;
